...
func (requ *AlipayTradePrecreateRequest) GetAPImethodName() string {
	return "alipay.trade.precreate"
}

// IsNeedEncrypt IsNeedEncrypt
func (requ *AlipayTradePrecreateRequest) IsNeedEncrypt() bool {
	return false
}

// IsNeedBizContent IsNeedBizContent
func (requ *AlipayTradePrecreateRequest) IsNeedBizContent() bool {
	return true
}